      ...
      <div>
        {
          ...
          loginModus && (
            <div className="fixed inset-0 h-screen w-screen backdrop-blur-sm bg-black/30 flex flex-col justify-center items-center z-50">
              ...
              {!LoginErforglech && (
                <div className="bg-white rounded-xl  p-10   w-96 relative">
                  <h1 className=" text-center text-teal-700 font-medium pb-2 uppercase">
                    {state}
                  </h1>
                  {state === "Login" && (
                    <form
                    ...
                    >
                      <span
                        onClick={() => setLoginModus(false)}
                        className="absolute top-1 right-4 cursor-pointer  text-teal-700 sm:hover:text-red-800 font-medium"
                      >
                        x
                      </span>
                      ...
                      <div className="flex border p-2 rounded items-center justify-between">
                        <input
                          ...
                          name="password"
                          type={passwortZeigen1 ? "text" : "password"}
                        ...
                        <button
                          type="button"
                          className=" sm:hover:text-red-800 font-medium"
                          onClick={() => setPasswortZeigen1((prev) => !prev)}
                        >
                          {passwortZeigen1 ? <FaRegEye /> : <FaRegEyeSlash />}
                        </button>
                      </div>

                      <button
                        type="onsubmit"
                        className="drop-shadow-lg px-4 mt-2  py-1 rounded bg-teal-500  text-white sm:hover:bg-teal-900"
                      >
                        {state}
                      </button>
                      <button
...

                  {
                    ...
                    state === "Sign Up" && (
                      <form
                        onSubmit={(e) => onSubmitHandleSignUp(e)}
                        className="flex flex-col gap-2"
                      >
                        <span
                          onClick={() => setLoginModus(false)}
                        ...
                        <label htmlFor="password">Passwort</label>
                        <div
                          className={`flex border p-2 rounded items-center justify-between ${
                            isPasswordStrong === "no" && "border-red-500"
                          }`}
                        >
                          <input
                            className="outline-none"
                            id="password"
                            name="password"
                            type={passwortZeigen ? "text" : "password"}
                            placeholder=" dein passwort"
                            value={password}
                            onChange={(e) => setPassword(e.target.value)}
                          ...
                          <button
                            type="button"
                            className=" sm:hover:text-red-800 font-medium"
                            onClick={() => setPasswortZeigen((prev) => !prev)}
                          >
                            {passwortZeigen ? <FaRegEye /> : <FaRegEyeSlash />}
                          </button>
                        </div>
                        {isPasswordFieldInFocus && (
                          <p className="m-0 text-xs text-teal-700">
                            Das Passwort muss mindestens 8 Zeichen lang sein und
                            mindestens 1 Sonderzeichen, 1 Großbuchstaben und 1
                            Zahl enthalten
                          </p>
                        )}
                        ...
                        <div
                          className={`flex border p-2 rounded items-center justify-between ${
                            isPassordEqual === "no" && "border-red-500"
                          }`}
                        >
                          <input
                            className="outline-none"
                          ...
                          <button
                            type="button"
                            className=" sm:hover:text-red-800 font-medium"
                            onClick={() => setPasswortZeigen2((prev) => !prev)}
                          >
                            {passwortZeigen2 ? <FaRegEye /> : <FaRegEyeSlash />}
                          </button>
                        </div>
                        <button
                          type="submit"
