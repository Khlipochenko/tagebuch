...
<div className='mx-auto'>
  <h1 className='text-2xl  mt-10 font-medium'>Du hast noch keine Entrage</h1>
        ...
        <div className='flex justify-center flex-col items-center max-sm:items-start '>
           <h1 className=' text-3xl mx-auto w-3/5  mt-96 text-center px-10 tracking-wide leading-loose font-medium text-emerald-950 h-auto  max-sm:text-lg max-sm:mt-20'>Bitte einloggen oder registrieren, um Zugang zu erhalten und dein Tagebuch zu starten.</h1>
