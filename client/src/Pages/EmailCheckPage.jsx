...
export const EmailCheckPage=()=>{
    ...
    return(
        ...
        <h2 className=" text-3xl mb-5 text-lime-950 max-sm:text-lg">Bitte prüffen Sie Ihre Email</h2>

       <p className="text-xl max-sm:text-sm">Dein Passwort-Zurücksetzungslink ist  <b>nur 2 Minuten</b> gültig. Bitte setze dein Passwort so schnell wie möglich zurück. Falls der Link abgelaufen ist, fordere einfach einen neuen an.</p>
